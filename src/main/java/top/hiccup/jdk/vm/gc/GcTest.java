 ...
 *
 * JVM采用了分代的思想：一般发生在堆区（回收对象）和元数据区（卸载类）
 * 1、GC后少量对象存活，适合复制算法
 ...
 *          CMS（标记-清除，并发回收，STW请求较少，JDK9已deprecated）
 *
 ...
 * 5、Epsilon GC(Java 11)：本身并不做垃圾回收，可以用在性能测试场景，判断GC本次产生了多大的开销
 *
 *======================================================================================================================
 * 目前生产采用：ParNew + CMS（互联网及B/S系统更加注重响应时间）

...
//            return sun.misc.Hashing.stringHash32((String) k);
    ...
    /* ---------------- Public operations -------------- */
    public MyConcurrentHashMap7(int initialCapacity, float loadFactor, int concurrencyLevel) {
    ...
    public MyConcurrentHashMap7(int initialCapacity, float loadFactor) {
        this(initialCapacity, loadFactor, DEFAULT_CONCURRENCY_LEVEL);
    }

    public MyConcurrentHashMap7(int initialCapacity) {
        this(initialCapacity, DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
    }

    public MyConcurrentHashMap7() {
        this(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, DEFAULT_CONCURRENCY_LEVEL);
    }

    public MyConcurrentHashMap7(Map<? extends K, ? extends V> m) {
    ...
    abstract class HashIterator {
        ...
        public final void remove() {
            ...
            MyConcurrentHashMap7.this.remove(lastReturned.key);
            lastReturned = null;
        }
    }
    ...
    final class WriteThroughEntry extends AbstractMap.SimpleEntry<K,V> {
        ...
        public V setValue(V value) {
            ...
            MyConcurrentHashMap7.this.put(getKey(), value);
            return v;
        }
    }
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public int size() {
            return MyConcurrentHashMap7.this.size();
        }
        public boolean isEmpty() {
            return MyConcurrentHashMap7.this.isEmpty();
        }
        public boolean contains(Object o) {
            return MyConcurrentHashMap7.this.containsKey(o);
        }
        public boolean remove(Object o) {
            return MyConcurrentHashMap7.this.remove(o) != null;
        }
        public void clear() {
            MyConcurrentHashMap7.this.clear();
        }
    }
    ...
    final class Values extends AbstractCollection<V> {
        ...
        public boolean contains(Object o) {
            return MyConcurrentHashMap7.this.containsValue(o);
        }
        public void clear() {
            MyConcurrentHashMap7.this.clear();
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = MyConcurrentHashMap7.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry<?,?> e = (Map.Entry<?,?>)o;
            return MyConcurrentHashMap7.this.remove(e.getKey(), e.getValue());
        }
        public int size() {
            return MyConcurrentHashMap7.this.size();
        }

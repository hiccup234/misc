...
// */
//
//package top.hiccup.jdk.container.jdk5;
//
...
//{
//    private transient java.util.LinkedList.Entry<E> header = new java.util.LinkedList.Entry<E>(null, null, null);
...
//        if (o==null) {
//            for (java.util.LinkedList.Entry<E> e = header.next; e != header; e = e.next) {
//                if (e.element==null) {
//                    remove(e);
//                    return true;
//                }
...
//        modCount++;
//
//        java.util.LinkedList.Entry<E> successor = (index==size ? header : entry(index));
//        java.util.LinkedList.Entry<E> predecessor = successor.previous;
//        for (int i=0; i<numNew; i++) {
//            java.util.LinkedList.Entry<E> e = new java.util.LinkedList.Entry<E>((E)a[i], successor, predecessor);
//            predecessor.next = e;
//            predecessor = e;
//        }
...
//     */
//    public void clear() {
//        java.util.LinkedList.Entry<E> e = header.next;
//        while (e != header) {
//            java.util.LinkedList.Entry<E> next = e.next;
...
//        java.util.LinkedList.Entry<E> e = entry(index);
//        E oldVal = e.element;
//        e.element = element;
//        return oldVal;
//    }
...
//     */
//    private java.util.LinkedList.Entry<E> entry(int index) {
//        if (index < 0 || index >= size)
//            throw new IndexOutOfBoundsException("Index: "+index+
//                    ", Size: "+size);
//        java.util.LinkedList.Entry<E> e = header;
//        if (index < (size >> 1)) {
...
//        int index = 0;
//        if (o==null) {
//            for (java.util.LinkedList.Entry e = header.next; e != header; e = e.next) {
//                if (e.element==null)
//                    return index;
//                index++;
//            }
...
//        int index = size;
//        if (o==null) {
//            for (java.util.LinkedList.Entry e = header.previous; e != header; e = e.previous) {
//                index--;
//                if (e.element==null)
//                    return index;
//            }
...
//        private java.util.LinkedList.Entry<E> lastReturned = header;
//        private java.util.LinkedList.Entry<E> next;
...
//        public void remove() {
//            checkForComodification();
//            java.util.LinkedList.Entry<E> lastNext = lastReturned.next;
//            try {
//                java.util.LinkedList.this.remove(lastReturned);
...
//
//        Entry(E element, java.util.LinkedList.Entry<E> next, java.util.LinkedList.Entry<E> previous) {
...
//    }
//
//    private java.util.LinkedList.Entry<E> addBefore(E o, java.util.LinkedList.Entry<E> e) {
//        java.util.LinkedList.Entry<E> newEntry = new java.util.LinkedList.Entry<E>(o, e, e.previous);
...
//    }
//
//    private E remove(java.util.LinkedList.Entry<E> e) {
//        if (e == header)
//            throw new NoSuchElementException();
//
//        E result = e.element;
...
//     */
//    public Object clone() {
//        java.util.LinkedList<E> clone = null;
//        try {
//            clone = (java.util.LinkedList<E>) super.clone();
//        } catch (CloneNotSupportedException e) {
//            throw new InternalError();
//        }
//
//        // Put clone into "virgin" state
//        clone.header = new java.util.LinkedList.Entry<E>(null, null, null);
...
//
//        // Initialize header
//        header = new java.util.LinkedList.Entry<E>(null, null, null);
//        header.next = header.previous = header;
//

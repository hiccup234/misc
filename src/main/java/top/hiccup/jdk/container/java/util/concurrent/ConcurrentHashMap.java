...
// */
//
//package top.hiccup.jdk.container.java.util.concurrent;
//
...
//
//import top.hiccup.jdk.container.java.util.HashMap;
//
///**
...
//     */
//    public int size() {
//        // TODO �����JDK1.7��size�������˺ܴ�ĸĶ�������ÿ���ζ���������ͳ�ƣ���ǿһ�����˻�Ϊ��һ���ԣ�
//        long n = sumCount();
//        return ((n < 0L) ? 0 :

...
public class ObjectSizeUtil {
    ...
    static {
        try {
            instrument = InstrumentationImpl.class.newInstance();
    ...
    /**
     * 第一种方法：计算当前对象占用空间大小
     * 包括:当前类及超类基本类型实例大小、引用类型引用大小、基本类型数组占用空间大小、引用类型数组引用本身大小
    ...
    /**
     * 第二种方法：计算当前对象占用空间的总大小
     * 包括：当前类及超类基本类型实例大小、引用类型引用大小、基本类型数组占用空间大小、引用类型数组引用本身大小、当前类及超类继承下来的引用对象大小、引用类型数组对象大小
     * @param obj
     * @return
     */

...
// TODO 1、AbstractQueuedSynchronizer的64位版本，private volatile long state;而不是private volatile int state;
// TODO 2、除了state是long以外，其他完全一样（Doug Lea这里怎么没做设计复用而是直接拷贝一份呢，有点奇怪）

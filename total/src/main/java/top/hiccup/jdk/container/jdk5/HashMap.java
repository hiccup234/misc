...
//        table = new java.util.HashMap.Entry[DEFAULT_INITIAL_CAPACITY];
//        init();
//    }
//
//    /**
...
//        for (java.util.HashMap.Entry<K,V> e = table[indexFor(hash, table.length)];
//             e != null;
//             e = e.next) {
//            Object k;
...
//        java.util.HashMap.Entry<K,V> e = table[i];
//        while (true) {
//            if (e == null)
//                return null;
//            if (e.key == NULL_KEY)
...
//        int i = indexFor(hash, table.length);
//        java.util.HashMap.Entry e = table[i];
//        while (e != null) {
...
//     * for this key.
//     */
//    java.util.HashMap.Entry<K,V> getEntry(Object key) {
//        Object k = maskNull(key);
//        int hash = hash(k.hashCode());
//        int i = indexFor(hash, table.length);
//        java.util.HashMap.Entry<K,V> e = table[i];
...
//        java.util.HashMap.Entry[] src = table;
//        int newCapacity = newTable.length;
//        for (int j = 0; j < src.length; j++) {
//            java.util.HashMap.Entry<K,V> e = src[j];
//            if (e != null) {
//                src[j] = null;
//                do {
...
//     * for this key.
//     */
//    java.util.HashMap.Entry<K,V> removeEntryForKey(Object key) {
//        Object k = maskNull(key);
//        int hash = hash(k.hashCode());
//        int i = indexFor(hash, table.length);
...
//     */
//    java.util.HashMap.Entry<K,V> removeMapping(Object o) {
...
//            // assert false;
//        }
//        result.table = new java.util.HashMap.Entry[table.length];
...
//
//        public K getKey() {
//            return java.util.HashMap.<K>unmaskNull(key);
//        }
//
//        public V getValue() {
//            return value;
...
//        table[bucketIndex] = new java.util.HashMap.Entry<K,V>(hash, key, value, e);
//        if (size++ >= threshold)
...
//            int i = t.length;
//            java.util.HashMap.Entry<K,V> n = null;
...
//        }
//
//        java.util.HashMap.Entry<K,V> nextEntry() {
...
//
//            java.util.HashMap.Entry<K,V> n = e.next;
//            java.util.HashMap.Entry[] t = table;
//            int i = index;
//            while (n == null && i > 0)
//                n = t[--i];
...
//    }
//
//    private class ValueIterator extends java.util.HashMap.HashIterator<V> {
//        public V next() {
//            return nextEntry().value;
//        }
//    }
//
//    private class KeyIterator extends java.util.HashMap.HashIterator<K> {
//        public K next() {
//            return nextEntry().getKey();
//        }
//    }
//
//    private class EntryIterator extends java.util.HashMap.HashIterator<Map.Entry<K,V>> {
...
//        return (es != null ? es : (entrySet = (Set<Map.Entry<K,V>>) (Set) new java.util.HashMap.EntrySet()));
//    }
//
...
//        table = new java.util.HashMap.Entry[numBuckets];
//
